...
(def max-concept-selections 2)                              ; don't set higher if not on a sumpercomputer, will cause trouble
...
(def system-tick-interval-slow 25)
(def inference-tick-interval-slow 20)
(def system-tick-interval-fast 15)
